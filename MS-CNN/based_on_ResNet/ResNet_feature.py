...
modules[4][1].register_forward_hook(forward_hook_function)#record middle-level feature
modules[7][1].register_forward_hook(forward_hook_function)#record high-level feature
##############define hook###########################

############pool function################
pool=nn.MaxPool2d(kernel_size=7,stride=8)
############pool function################
