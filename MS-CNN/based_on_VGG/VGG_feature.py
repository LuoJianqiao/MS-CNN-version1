...
modules[33][1].register_forward_hook(forward_hook_function)#record the middle-level feature
modules[43][1].register_forward_hook(forward_hook_function)#record the high-level feature
##############define hook###########################
